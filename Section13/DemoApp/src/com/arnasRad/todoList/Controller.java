...
import com.arnasRad.todoList.data_model.TodoItem;
...
//                "See DDr. Smith at 123 Main Street. Bring paperwork",
...
//            todoListView.getItems().setAll(TodoData.getInstance().getTodoItems());
    ...
    public void handleClickListView() {
        // unnecessary after adding selectedItemProperty listener
//        TodoItem item = todoListView.getSelectionModel().getSelectedItem();
//        itemDetailsTextArea.setText(item.getDetails());
//        deadlineLabel.setText(item.getDeadline().toString());

        // unnecessary after separating labels into details and deadline
