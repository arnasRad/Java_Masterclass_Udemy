...
public class Album {
    ...
    private void addSong() {
        ...
        songList.add(new Song(name, minutes, seconds), this);
    }
    ...
    private void showSongInfo() {
        ...
        Song song = songList.get(option-1);
    ...
    private class SongList {
        ...
        private void add(Song song, Album album) {
            Song tempSong = get(song.getTitle());
            if (tempSong != null) {
                System.out.println("Song " + song.getTitle() +
                        " is already in album " + album.getName());
                return;
            }
            ...
            this.songs.add(song);
            System.out.println("Song " + song.getTitle() +
                    " successfully added to album " + album.getName());
        }
